  ...
  <div>
    <div class="goods">
      <div class="menu-wrapper" ref="menuWrapper">
        <ul>
          <li v-for="(item,index) in goods" v-bind:key="index" class="menu-item" :class = "{'current':currentIndex===index}" @click = "selectMenu(index)">
  ...
  export default {
    ...
    data () {
      return {
        ...
        listHeight: [],
        scrollY: 0,
        // data里观测的数据名称不能与methods里面的重名，都能通过this访问到，会有一个被覆盖
        selectedFood: {}
      };
    },
    computed: {
